...
Once all three pass: set the tracker's Status to `Complete`, make a final commit and push, then perform the strategy's completion action — see `references/pr-strategies.md → Final-completion behaviour`.
